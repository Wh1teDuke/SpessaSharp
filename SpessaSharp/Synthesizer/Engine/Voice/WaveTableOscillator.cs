...
{
    /// <summary>The interpolation type used.</summary>
    ...
    public bool Process(
        ...
        Type switch
        {
            Synthesizer.InterpolationType.Linear => 
                ProcessLinear(sampleCount, tuningRatio, outputBuffer),
            Synthesizer.InterpolationType.NearestNeighbor => 
                ProcessNearest(sampleCount, tuningRatio, outputBuffer),
            Synthesizer.InterpolationType.Hermite => 
                ProcessHermite(sampleCount, tuningRatio, outputBuffer),
            _ => throw new ArgumentOutOfRangeException(),
        };

    public bool ProcessLinear(
        int sampleCount, float tuningRatio, Span<float> outputBuffer)
    {
